...
public class GSTReceivedFileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_g_s_t_received_file, container, false);

        gstRecyclerView = view.findViewById(R.id.gstRecyclerView);

        ITRFileResponse[] myListData = new ITRFileResponse[]{
                new ITRFileResponse("GST file File-Name file"),

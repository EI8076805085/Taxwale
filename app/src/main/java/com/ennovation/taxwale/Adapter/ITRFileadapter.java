...
public class ITRFileadapter extends RecyclerView.Adapter<ITRFileadapter.ViewHolder> {
    private ITRFileResponse[] listdata;
    Context context;

    public ITRFileadapter(ITRFileResponse[] myListData, FragmentActivity activity) {
